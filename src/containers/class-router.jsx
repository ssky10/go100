...
import LiveQuiz from "containers/board/livequizboard/livequiz";
      ...
      >
        <Switch>
          ...
          <Route
            ...
            render={() => <NoticeBoard boardIdx={1} token={token} />}
          />
          <Route
            path={`${match.url}/work`}
            render={() => <WorkBoard boardIdx={2} token={token} />}
          />
          <Route
            exact
            path={`${match.url}/qna`}
          ...
          <Route
            ...
            render={() => <TeacherBoard boardIdx={5} token={token} />}
          />
        </Switch>
      </TemplateContainer>
    );
